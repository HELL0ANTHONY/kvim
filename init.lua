...
vim.keymap.set(
  ...
  "<leader>cp",
  "<cmd>Preview<cr>",
  { desc = "Code Preview start" }
)
vim.keymap.set(
  "n",
  "<leader>cP",
  "<cmd>PreviewStop<cr>",
  { desc = "Code Preview stop" }
)
vim.keymap.set(
  "n",
  "<leader>cr",
  "<cmd>RemoveCommentsInline<cr>",
  { desc = "Remove inline comments" }
)
vim.keymap.set(
  "n",
  "<leader>cR",
  "<cmd>RemoveCommentsAll<cr>",
  { desc = "Remove all comment lines" }
)
...
vim.keymap.set(
  ...
  "<leader>cu",
  "<cmd>CssToggle<cr>",
  { desc = "CSS toggle px/rem" }
)
vim.keymap.set(
  "n",
  "<leader>cv",
  "<cmd>CssToggleVw<cr>",
  { desc = "CSS toggle px/vw" }
)
vim.keymap.set(
  "n",
  "<leader>cc",
  "<cmd>ColorToggle<cr>",
  { desc = "Color cycle format" }
)
vim.keymap.set(
  "n",
  "<leader>ch",
...
vim.keymap.set(
  "n",
  "<leader>fj",
  "<cmd>JsonTplFormat<cr>",
  { desc = "Format JSON/TPL" }
)
vim.keymap.set(
  "n",
  "<leader>fJ",
  "<cmd>JsonTplValidate<cr>",
  { desc = "Validate JSON/TPL" }
)
