...
vim.fn.sign_define('DiagnosticSignHint', { text = '󱐋', hl = 'DiagnosticSignHint', texthl = 'DiagnosticSignHint', culhl = 'DiagnosticSignHintLine' })
